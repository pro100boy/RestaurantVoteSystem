...
public class ResultTestData {
    ...
    public static final VoteTo VOTE_TO1 = new VoteTo(100004, RestaurantTestData.RESTAURANT1.getName(), 1);
    public static final VoteTo VOTE_TO2 = new VoteTo(100005, RestaurantTestData.RESTAURANT2.getName(), 1);
    public static final VoteTo VOTE_TO3 = new VoteTo(100006, RestaurantTestData.RESTAURANT3.getName(), 2);

    public static final List<VoteTo> VOTE_TO_LIST = new ArrayList<>(Arrays.asList(VOTE_TO3, VOTE_TO1, VOTE_TO2));
}
